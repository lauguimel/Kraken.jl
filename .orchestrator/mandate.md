...
| LU / real-units conversion | `src/units/` | `src/units/` (15 files, `dev/units-module`) — Newt+VE concrete, thermal/GNF/MP/MHD raising stubs | **IMPLEMENTED** Phase 1 (M4, 2026-05-29; 165 tests green). Thermal Phase-2 = M5. Driver-integration Cd repro deferred to post-merge | dimensional analysis closure tests (165 pass: parity 1e-12, round-trip, audit, krk) | n/a (utility module — verified via downstream module benchmarks) |
