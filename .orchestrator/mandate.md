...
| LU / real-units conversion | `src/units/` | spec frozen (`docs/spec/units-v1.md`, `dev/units-module`); impl not yet created | **SPEC-FROZEN** (KRK-UNITS-001, 2026-05-29) — M4 implements Phase 1 (Newt+VE) | dimensional analysis closure tests | n/a (utility module — verified via downstream module benchmarks) |
