...
@testset "Kraken.jl LBM" begin
    ...
    include("test_viscoelastic_equations.jl")
    include("test_viscoelastic_equation_patch_ladder.jl")
    include("test_viscoelastic_force_accounting.jl")
    include("test_polymeric_drag_geometry.jl")
    include("test_viscoelastic_patch_tests.jl")
    include("test_conformation_lbm.jl")
    include("test_conformation_cylinder.jl")
    include("test_logconformation.jl")
    include("test_logconformation_3d.jl")
    include("test_fvfd_operators_2d.jl")
